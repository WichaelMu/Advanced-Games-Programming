...
APickup::APickup()
{
	...
	PickupSceneComponent = CreateDefaultSubobject<USceneComponent>(TEXT("Pickup Component"));
	...
	PickupBoundingBox->SetWorldScale3D(FVector(1.f, 2.f, 1.f));
}
